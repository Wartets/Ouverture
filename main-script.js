...
const doors = new Map([
	...
	['doorExteriorHighschool', { x: 1415, y: 55, w: 50, h: 50, from: 'townMap', to: 'exteriorHighschool' }],
	...
	['doorExteriorWarehouse', { x: 626, y: 72, w: 50, h: 50, from: 'townMap', to: 'exteriorWarehouse' }],
	...
	['doorExteriorWorkshop', { x: 1063, y: 494, w: 50, h: 50, from: 'townMap', to: 'exteriorWorkshop' }],
	['doorExteriorCastel', { x: 1343, y: 557, w: 50, h: 50, from: 'townMap', to: 'exteriorCastel' }],
	...
	['doorVineyard', { x: 124, y: 188, w: 50, h: 50, from: 'townMap', to: 'vineyard' }],
	['doorExteriorStation', { x: 327, y: 307, w: 50, h: 50, from: 'townMap', to: 'exteriorStation' }],
	['doorExteriorPuclicHousing', { x: 517, y: 462, w: 50, h: 50, from: 'townMap', to: 'exteriorPuclicHousing' }],
	...
	['doorExteriorPark', { x: 1060, y: 753, w: 50, h: 50, from: 'townMap', to: 'exteriorPark' }],
	['doorForest', { x: 1315, y: 880, w: 50, h: 50, from: 'townMap', to: 'forest' }],
	...
	['doorNeighbourSee2', { x: 1350, y: 470, w: 50, h: 60, from: 'exterior', to: 'neighbourSee' }],
	...
	['exit-neighbourSee', { from: 'neighbourSee', to: 'garden' }],
